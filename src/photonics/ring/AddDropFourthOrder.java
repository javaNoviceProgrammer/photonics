...
//		Complex gain = minusJ.times(phi_rad/2).exp().times(Math.pow(L, 0.25)) ;
		...
		sfg.addArrow("DC5.N1", "DC5.N2", tout);
		sfg.addArrow("DC5.N1", "DC5.N3", -j*kout);
		sfg.addArrow("DC5.N4", "DC5.N3", tout);
		sfg.addArrow("DC5.N4", "DC5.N2", -j*kout);
