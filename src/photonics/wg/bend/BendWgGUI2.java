...
public class BendWgGUI2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BendWgGUI2 frame = new BendWgGUI2();
	...
	public BendWgGUI2() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(BendWgGUI2.class.getResource("/com/sun/javafx/scene/control/skin/modena/HTMLEditor-Paste-Black.png")));
		try {
		...
		gbc_lblWaveguide.insets = new Insets(0, 0, 5, 5);
	...
	protected void setupLossModel() {
		...
		if(selected.equals("WG 450x220 nm - Strip")) {
			aTextField.setEditable(false);
			bTextField.setEditable(false);
			wTextField.setEditable(false);
			aTextField.setText("181.98");
			bTextField.setText("2.49");
			wTextField.setText("0.45");
		}
		if(selected.equals("WG 500x220 nm - Strip")) {
			aTextField.setEditable(false);
			bTextField.setEditable(false);
			wTextField.setEditable(false);
			aTextField.setText("181.98");
			bTextField.setText("2.49");
			wTextField.setText("0.5");
		}
